...
import 'package:myapplication/ui/navigator.dart';
...
class _UserwidgetState extends State<Userwidget> {
  ...
  Future<void> _selectDateFromePicker(BuildContext context) async {
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          children: [
            ...
            Text(
              "we will not shere your information",
              style: TextStyle(
                fontSize: 15.sp,
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                    onPressed: () => _selectDateFromePicker(context),
